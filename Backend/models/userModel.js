...
const userSchema = new mongoose.Schema(
  {
    ...
    password: {
      type: String,
      required: true,
      // Make sure to hash the password before saving in real applications
    },
    avatar: {
      type: String,
      default:
    ...
    favourites: [
      {
        ...
        ref: "Book", // Ensure it matches the Book model name
      },
    ],
    cart: [
      {
        type: mongoose.Types.ObjectId,
        ref: "Books", // Ensure it matches the Book model name
      },
    ],
    orders: [
      {
